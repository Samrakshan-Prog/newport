  ...
  return (
    ...
    >
      ...
      >
        ...
        developer creating modern applications.
      </motion.h1>
      <motion.p
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
       I'm Srisamrakshan, a MERN stack dev skilled in React,Node.js & MongoDB.
       I also build Python+Flask+OpenCV apps with image Encryption.
       I craft-platform apps using Electron.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <Button variant="outline" size="lg" className="hidden sm:flex" asChild>
          <a href="/Srisamrakshan.pdf" target="_blank" rel="noreferrer">
